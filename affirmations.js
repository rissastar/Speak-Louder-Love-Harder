...
async function loadAffirmations() {
  ...
  const feed = document.getElementById('affirmationFeed')
  feed.innerHTML = ''
  data.forEach(a => {
...
loadAffirmations()
supabase.channel('realtime:affirmations')
  .on('postgres_changes', { event: '*', schema: 'public', table: 'affirmations' }, loadAffirmations)
  .subscribe()